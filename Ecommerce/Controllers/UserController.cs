...
namespace Ecommerce.Controllers
{
	public class UserController : Controller
	{
		...
		public async Task<IActionResult> Login(string UserName, string Password)
		{
			...
			{
				var isExist = _context.Users.FirstOrDefault(x => x.UserName == UserName || x.PhoneNumber == UserName);

				if (isExist == null)
				{
					TempData["Notif"] = Notification.ShowNotif(MessageType.BadLogin, type: ToastType.red);
					return View();
				}
