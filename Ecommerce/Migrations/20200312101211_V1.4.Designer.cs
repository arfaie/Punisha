...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Models.ProductCategoryFields", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Ecommerce.Models.ProductSelectedItems", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("IdProductField");

                    b.HasKey("Id");

                    b.HasIndex("IdItem");

                    b.HasIndex("IdProductField");
            ...
            modelBuilder.Entity("Ecommerce.Models.ProductSelectedItems", b =>
                {
                    b.HasOne("Ecommerce.Models.SelectItem", "ItemList")
                        .WithMany()
                        .HasForeignKey("IdItem")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Ecommerce.Models.ProductField", "ProductFieldList")
                        .WithMany()
                        .HasForeignKey("IdProductField")
                        .OnDelete(DeleteBehavior.Cascade);
                });
